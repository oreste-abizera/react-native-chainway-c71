...
public class ChainwayC71Module extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    public void getDeviceModel(Promise promise) {
        ...
        try {
            ...
            promise.reject("GET_DEVICE_MODEL_ERROR",err.getLocalizedMessage());
        }
    }
    ...
    public void createUUID(Promise promise) {
        try {
            ...
            promise.reject("CREATE_UUID_ERROR",err.getLocalizedMessage());
        }
    }
    ...
    public void isReaderInit(Promise promise) {
        try {
            ...
            promise.reject("READER_INIT_ERROR",err.getLocalizedMessage());
        }
    }
